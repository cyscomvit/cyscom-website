...
const OurJourney = () => {
  ...
  const timelineData = [
    { img:  ProposalLogo, desc: "CYSCOM is proposed for approval.", label: 'January 10th, 2022' },
    { img:  CheckLogo,desc: "The Cyscom Student Community (CYSCOM) is officially formed.", label: 'January 15th, 2022' },
    { img:  RocketLogo,desc: "CYSCOM kicks into action.", label: 'February 1st, 2022' },
    { img:  StarLogo,desc: "CYSCOM VIT hosts Cyber Defender, a 2 day technical and fun event for all Cyber enthusiasts, with a workshop and a CTF event.", label: 'April 19th-20th, 2022' },
  ];
        ...
        <div className="flex flex-row-reverse lg:flex-col-reverse max-w-7xl mx-auto w-full md:justify-center">
          ...
          <div className="flex flex-col max-w-7xl mx-auto absolute lg:top-0 top-20 lg:relative w-full md:w-fit md:items-center px-5">
              ...
              <p className='w-1/2 md:w-full mt-4 text-sm text-[#88B7FD]'>The Cybersearity Student Community (CYSCOM) was formed in 2022 and ever Since it has had one aim only. spreading
                awareness about cyber security and malware as welt as ransomware threats in society and circles of students and teaching
                them how to deploy counter measures through various events and undertakings.
              </p>
          </div>
        </div>
    </div>
