...
const Navbar = () => {
  ...
  return (
    <nav className='relative max-w-7xl w-full mx-auto flex px-4 pt-6 lg:py-2 items-center justify-center lg:justify-between'>
        <img className='h-[74px] lg:h-[62px] absolute lg:relative top-0 left-0 my-6 mx-4 lg:mx-5 lg:my-4' src={logo} alt="logo" />
        ...
        {
            isNavBarVisible && 
            <nav ref={mobileMenu} className='z-20 absolute right-10 top-24 bg-white rounded-2xl shadow-[0_0_50px_5px_rgb(165,_165,_165)] p-10 min-w-[280px]'>
            <ul className='space-y-8 text-xl text-[#2460ba] font-semibold'>
              ...
              <li>
                <a className='flex items-center space-x-4' href="https://opensrc.cyscomvit.com/leaderboard">
                  <div>
              ...
              <li>
                <a className='flex items-center space-x-4' href="https://blog.cyscomvit.com/">
                  <div>
              ...
              <li>
                <a className='flex items-center space-x-4' href="https://github.com/cyscomvit/">
                  <div>
